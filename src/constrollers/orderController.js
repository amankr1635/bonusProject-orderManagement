...
if(noOfOrders>= 10 && noOfOrders <20){
    ...
    update = {$set:{moneyBack:moneyBack,category:"gold"},$inc : {noOfOrders:1}}
//   update = {_id:body.customerId},{$set:{moneyBack:moneyBack,category:"gold",$inc : {noOfOrders:1}}}
...
if(noOfOrders>=20){
    ...
    update = {$set:{moneyBack:moneyBack,category:"platinum"},$inc : {noOfOrders:1}}

    // update = {_id:body.customerId},{$set:{moneyBack:moneyBack,category:"platinum"},$inc:{noOfOrders:1}}
